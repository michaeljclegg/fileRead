...
const fileToGenerativePart = (file: File) => {
    return new Promise<any>((resolve, reject) => {
        ...
        // For PDF, we must use inlineData (base64).
        // For other supported types (text, code, json, etc.), sending as text part is more reliable
        // and avoids potential parsing errors on the backend.
        if (isPdf) {
            ...
            // Assume text-based for all other supported types
            const reader = new FileReader();
